                ...
                <aside class="w-64 bg-white border-r border-gray-200 min-h-[calc(100vh-4rem)] hidden md:block">
                    <nav class="p-4 space-y-1">
                        ...
                        <div class="pt-4 mt-4 border-t border-gray-200">
                            ...
                            <a href="{{ route('settings.edit') }}" class="flex items-center gap-2 px-3 py-2 mt-2 text-sm font-medium rounded-md {{ request()->routeIs('settings.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50' }}">
